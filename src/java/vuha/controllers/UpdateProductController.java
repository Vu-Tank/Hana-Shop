...
import vuha.dtos.ProductErrorDTO;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user != null && "AD".equals(user.getRoleID())) {
                ...
                String caegoryID = request.getParameter("cbxcatrgory");
                ...
                if (check) {
                    ProductDTO product = new ProductDTO(productID, productName, caegoryID, description, fileName, price, quantity, createDate, status);
