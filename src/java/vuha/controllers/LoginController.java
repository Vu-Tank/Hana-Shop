...
public class LoginController extends HttpServlet {
    ...
    private static final String USSUCCESS = "ViewProductController";
    private static final String ADSUCCESS = "AdminController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userID.isEmpty()) {
                request.setAttribute("userIDError", "User ID not empty!");
            }
            ...
            if (!userID.isEmpty() && !password.isEmpty()) {
                ...
                if (user != null) {
                    ...
                    request.setAttribute("LOGINERROR", "May be wrong userID or password!");
                }
            }
        } catch (Exception e) {
